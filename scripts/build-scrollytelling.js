      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden flex flex-col justify-between selection:bg-purple-600/30 selection:text-white">
        ...
        <header className="relative z-20 pt-8 px-6 sm:px-12 flex items-center justify-between">
          ...
          <div className="hidden sm:flex items-center gap-2">
            <span
              className={\`rounded-full px-3 py-1 text-[11px] font-semibold border transition-all duration-500 \${
                isExternalExecution
        ...
        <div className="relative z-20 flex-1 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center max-w-7xl mx-auto w-full px-6 sm:px-12 py-4">
          <div className="lg:col-span-6 flex flex-col justify-center max-w-xl">
            <AnimatePresence mode="wait">
              ...
              >
                <div className="inline-flex items-center gap-2 rounded-md border border-purple-500/30 bg-purple-950/40 px-3 py-1 text-[11px] font-mono font-semibold text-purple-300 mb-4">
                ...
                <p className="mt-2 text-xs sm:text-sm font-semibold text-purple-300/90 tracking-wide uppercase">
                  {current.subheadline}
                </p>

                <p className="mt-4 text-sm sm:text-base leading-relaxed text-slate-300/90 max-w-lg">
                  {current.copy}
                </p>
            ...
            <AnimatePresence mode="wait">
              ...
              {activeStep === 6 && (
                ...
                >
                  <div className="w-full flex items-center justify-between pb-3 border-b border-white/10 text-xs text-purple-400 font-bold">
                    <span className="flex items-center gap-1.5">
                      <Radio className="size-4 animate-pulse text-purple-400" />
                      LIVE CONVERSATION INTENT RADAR
                    </span>
                    <span className="text-[10px] text-emerald-400">24H FRESHNESS</span>
                  </div>
                  ...
                  <div className="w-full my-4 space-y-3 font-sans">
                    <div className="rounded-2xl border border-emerald-500/40 bg-emerald-950/20 p-3.5">
                      <div className="flex items-center justify-between text-[11px]">
                        <span className="font-bold text-white">r/marketing • 3h ago</span>
                      ...
                      <p className="mt-2 text-xs text-slate-200 italic">
                        "We are migrating away from SEMrush because it lacks multi-agent AI features."
                      </p>
                      <span className="mt-2 block text-[10px] text-slate-400">
                        Trigger: Explicit tool migration • Outbound hook generated
                      </span>
                    </div>

                    <div className="rounded-2xl border border-purple-500/30 bg-purple-950/20 p-3.5">
                      <div className="flex items-center justify-between text-[11px]">
                        <span className="font-bold text-white">LinkedIn Discussion</span>
                        <span className="rounded-full bg-purple-500/20 border border-purple-500/30 px-2 py-0.5 text-[10px] font-bold text-purple-300">
                          94 / 100 (Strong)
                        </span>
                      </div>
                      <p className="mt-2 text-xs text-slate-200 italic">
                        "Looking for an automated platform that unifies all marketing reports into board slides."
                      </p>
                    </div>

                    <div className="rounded-xl border border-white/10 bg-white/5 p-2.5 flex items-center justify-between text-[10px] text-slate-400">
                      <span>Automated 100-Pt Grading Engine</span>
                      <span className="text-emerald-400 font-mono">0% SDR Time Wasted</span>
                    </div>
                  </div>
                </motion.div>
              )}
...
fs.writeFileSync('src/components/scrollytelling-eight-layers.tsx', fileContent, 'utf8');
console.log('SUCCESS: Generated src/components/scrollytelling-eight-layers.tsx');
